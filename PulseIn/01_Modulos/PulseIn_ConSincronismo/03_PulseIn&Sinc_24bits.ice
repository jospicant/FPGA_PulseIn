{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "191bbab1-5196-4b97-8d5a-91131d6adb17",
          "type": "basic.output",
          "data": {
            "name": "Count",
            "range": "[23:0]",
        ...
        {
          "id": "0ad313a2-06d9-4a56-93b9-61c379d666dc",
          "type": "basic.output",
          "data": {
            "name": "Time",
            "range": "[23:0]",
        ...
        {
          "id": "064426df-e426-4e48-9807-ee4db366cd09",
          "type": "basic.output",
          "data": {
            "name": "PulseInD",
            "pins": [
        ...
        {
          "id": "7d9bdb9d-9709-43a0-8cfc-1e2da6ba3e73",
          "type": "1c5d54983c4984701e343b862a97baad8f34ae63",
          "position": {
            "x": 728,
            "y": 160
          },
        ...
        {
          "id": "748241ce-e8dc-4dd0-8706-aeffc61126c4",
          "type": "ec9326f89d857b89efe33f2b5e1fcc19effc1320",
          "position": {
            "x": 1024,
            "y": 192
          },
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "748241ce-e8dc-4dd0-8706-aeffc61126c4",
        ...
        },
        {
          ...
          "target": {
            "block": "7d9bdb9d-9709-43a0-8cfc-1e2da6ba3e73",
        ...
        },
        {
          ...
          "target": {
            "block": "064426df-e426-4e48-9807-ee4db366cd09",
            "port": "in"
          },
          "vertices": [
            {
        ...
        },
        {
          "source": {
            "block": "7d9bdb9d-9709-43a0-8cfc-1e2da6ba3e73",
            "port": "ff99255c-a972-4e7b-bf5f-6b55b5d5734f"
          },
          "target": {
            "block": "748241ce-e8dc-4dd0-8706-aeffc61126c4",
            "port": "92d272d4-96ee-48cb-b40e-ef693d83c80b"
          },
          "size": 24
        },
        {
          "source": {
            "block": "748241ce-e8dc-4dd0-8706-aeffc61126c4",
            "port": "6a2f73f3-0434-48ef-98e8-f747c0859457"
          },
          "target": {
            "block": "0ad313a2-06d9-4a56-93b9-61c379d666dc",
            "port": "in"
          },
          "size": 24
        },
        {
          ...
          "target": {
            "block": "191bbab1-5196-4b97-8d5a-91131d6adb17",
            "port": "in"
          },
          "vertices": [
            {
  ...
  "dependencies": {
    ...
    "1c5d54983c4984701e343b862a97baad8f34ae63": {
      "package": {
        "name": "C_24bits EnableReset",
        "version": "0.1",
        "description": "Contador de 24bits con Enable-Reset y Overflow",
      ...
      "design": {
        "graph": {
          "blocks": [
            ...
            {
              "id": "ff99255c-a972-4e7b-bf5f-6b55b5d5734f",
              "type": "basic.output",
              "data": {
                "name": "count",
                "range": "[23:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "ff99255c-a972-4e7b-bf5f-6b55b5d5734f",
                "port": "in"
              },
              "size": 24
            }
    ...
    "ec9326f89d857b89efe33f2b5e1fcc19effc1320": {
      "package": {
        "name": " D 16 & load",
        "version": "v1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "92d272d4-96ee-48cb-b40e-ef693d83c80b",
              "type": "basic.input",
              "data": {
                "name": "D",
                "range": "[23:0]",
            ...
            {
              "id": "6a2f73f3-0434-48ef-98e8-f747c0859457",
              "type": "basic.output",
              "data": {
                "name": "q",
                "range": "[23:0]",
          ...
          "wires": [
            ...
            },
            {
              ...
              "target": {
                "block": "6a2f73f3-0434-48ef-98e8-f747c0859457",
                "port": "in"
              },
              "size": 24
            },
            {
              "source": {
                "block": "92d272d4-96ee-48cb-b40e-ef693d83c80b",
                "port": "out"
              },
              "target": {
                "block": "099db605-2cf8-4928-9e98-0ebe4460dd20",
