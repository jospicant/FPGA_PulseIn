    ...
    "graph": {
      "blocks": [
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\n### Contador ancho de un Pulso.                             \n\n**Status: Checked Ok** con \"ScriptComunicator\" \n\nSi se realiza un programa para capturar los datos, procesarlos... habrá que tener  \nen cuenta todo el procesamiento, velocidades de refresco  de la pantalla..",
            "readonly": false
          },
          "position": {
            "x": -104,
