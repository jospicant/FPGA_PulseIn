{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        ...
        {
          "id": "bebe44df-2312-4946-9dfb-c5514902e1d9",
          "type": "basic.constant",
          "data": {
            "name": "Tic_sg",
            "value": "1",
        ...
        {
          "id": "be752df0-dcea-4593-a152-63f7ecb98844",
          "type": "basic.constant",
          "data": {
            "name": "Modulo",
            "value": "11",
        ...
        {
          "id": "408e12bf-0517-40d1-9945-1e385fdc3513",
          "type": "basic.constant",
          "data": {
            "name": "Periodo",
            "value": "100",
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\n### Contador ancho de un Pulso\n\n\nStatus Check = Ok   Chequeado con Scriptcomunicator y con el program realizado en  \nprocessing, este  no está optimizado y no lo soporta correctamente por debajo de unos 52ms   \nde periodo del PWM, ya que hay tiempos de porcesamiento, referesco de pantalla...que sobrepasarán  \nel tiempo de poder capturar 2 datos consecutivos, pudiendo solapar datos.",
            "readonly": true
          },
          "position": {
            "x": -136,
        ...
        },
        {
          ...
          "type": "basic.info",
          "data": {
            "info": "\n**OJO !**\nEl módulo detector de pulsos, es  \ncapaz de medir con una resolución  \nde un periodo del reloj del sistema  \ncon un error de 1 periodo de reloj,  \npero...  \nEl módulo transmisor no es capaz de   \nenviarlos a tanta velocidad...  \nSi...  \nlos pulsos a medir entran a mayor  \nvelocidad de lo que se puede transmitir  \npor el puerto serie, entonces, podremos  \nsolapar datos y el resultado que se  \ntransmite será incorrecto.\n\nEn función de la aplicación, puede  \nque no podamos trx todos los pulsos  \npor el puerto serie, si no queremos  \nsaturarlo y sobreescribir datos...  \n",
            "readonly": true
          },
          "position": {
            "x": 1072,
        ...
        {
          "id": "50d9ecf2-eabe-41a4-b7cf-2d86157155b0",
          "type": "27cdbce60502726946336133ce9cd5e8235108e1",
          "position": {
            "x": 248,
            "y": 312
          },
        ...
        {
          "id": "41de6e42-ec16-450f-830e-a3df4b74da44",
        ...
        {
          "id": "9f50772e-ed50-4302-b4ba-93e40b3b0ca7",
        ...
        {
          "id": "19f4d8ba-e849-4d7e-bed2-ad601a6b5a78",
        ...
        {
          "id": "569196e1-719b-4a48-9f0b-f079cacb3ae4",
      ...
      "wires": [
        {
          ...
          "target": {
            "block": "569196e1-719b-4a48-9f0b-f079cacb3ae4",
        ...
        {
          "source": {
            "block": "50d9ecf2-eabe-41a4-b7cf-2d86157155b0",
        ...
        {
          "source": {
            "block": "408e12bf-0517-40d1-9945-1e385fdc3513",
            "port": "constant-out"
          },
          "target": {
            "block": "50d9ecf2-eabe-41a4-b7cf-2d86157155b0",
        ...
        {
          "source": {
            "block": "41de6e42-ec16-450f-830e-a3df4b74da44",
            "port": "e2091457-8509-494f-96fc-4a2907d9575f"
          },
          "target": {
            "block": "50d9ecf2-eabe-41a4-b7cf-2d86157155b0",
            "port": "53be6576-9003-435a-be7b-a3923c7f2192"
          },
          "size": 8
        },
        {
          "source": {
            "block": "9f50772e-ed50-4302-b4ba-93e40b3b0ca7",
        ...
        {
          "source": {
            "block": "bebe44df-2312-4946-9dfb-c5514902e1d9",
            "port": "constant-out"
          },
          "target": {
            "block": "9f50772e-ed50-4302-b4ba-93e40b3b0ca7",
        ...
        {
          "source": {
            "block": "19f4d8ba-e849-4d7e-bed2-ad601a6b5a78",
        ...
        {
          "source": {
            "block": "be752df0-dcea-4593-a152-63f7ecb98844",
            "port": "constant-out"
          },
          "target": {
            "block": "41de6e42-ec16-450f-830e-a3df4b74da44",
  ...
  "dependencies": {
    ...
    "27cdbce60502726946336133ce9cd5e8235108e1": {
      "package": {
        "name": "PWM 8bits",
        "version": "4.0",
        "description": "PWM Signal using a counter From-To modified",
        "author": "José Picó",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "53be6576-9003-435a-be7b-a3923c7f2192",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[7:0]",
            ...
            {
              "id": "7a0298ff-2205-4bb3-8220-9be2440333f0",
              "type": "5487806d5f045318191c6d15e36065db7459bcdb",
              "position": {
                "x": 504,
                "y": 208
              },
            ...
            {
              "id": "1907a779-f4ef-4b2f-a03a-121457c7fa8a",
          ...
          "wires": [
            {
              ...
              "target": {
                "block": "1907a779-f4ef-4b2f-a03a-121457c7fa8a",
            ...
            {
              "source": {
                "block": "7a0298ff-2205-4bb3-8220-9be2440333f0",
            ...
            {
              "source": {
                "block": "53be6576-9003-435a-be7b-a3923c7f2192",
                "port": "out"
              },
              "target": {
                "block": "7a0298ff-2205-4bb3-8220-9be2440333f0",
                "port": "d8d8509f-7911-4820-83c1-116411e1bb7b"
              },
              "vertices": [
                {
                  "x": 400,
    ...
    "5487806d5f045318191c6d15e36065db7459bcdb": {
      "package": {
        "name": "Counter 8bits",
        "version": "1.0",
      ...
      "design": {
        "graph": {
          "blocks": [
            {
              "id": "d8d8509f-7911-4820-83c1-116411e1bb7b",
              "type": "basic.input",
              "data": {
                "name": "Dutty",
                "range": "[7:0]",
          ...
          "wires": [
            ...
            {
              "source": {
                "block": "d8d8509f-7911-4820-83c1-116411e1bb7b",
                "port": "out"
              },
              "target": {
                "block": "17174045-a45c-4f73-8dd4-50651082b454",
